              ...
              <div className="space-y-4">
                <div className={`flex items-center gap-3 rounded-xl p-4 ${result.label === "Fake" ? "border border-destructive/30 bg-destructive/10 glow-destructive" : "border border-success/30 bg-success/10"}`}>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">{result.confidence}% {result.label === "Fake" ? "manipulated" : "authentic"}</p>
                  </div>
                </div>
                <div>
                ...
                <div className="rounded-lg border border-border bg-secondary/50 p-3">
                  ...
                  <p className="text-xs leading-relaxed text-muted-foreground">{result.confidenceText}</p>
                </div>
                {result.label === "Fake" && (
